 ...
 * @author Aluno
 */
public class TodasConsultasDataRelatorio extends javax.swing.JInternalFrame {

    private ControleConsulta controle;

    public TodasConsultasDataRelatorio() {

        controle = new ControleConsulta();

        initComponents();
        data1.setDate(getDateWithoutTime(new Date()));
    ...
    private void initComponents() {
        ...
        listaCon =  org.jdesktop.observablecollections.ObservableCollections.observableList(controle.listaConsultasMedPeriodo(ControleMedico.getLogado(), getDateWithoutTime(new Date()),new Date() ));
        ...
        txtmed.setText("Gerar Relatório de Consultas");
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/IconesNovos/icons8-Purchase Order-50.png"))); // NOI18N
        ...
        data1.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N

        data2.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(data1, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26)
                        .addComponent(jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        .addComponent(jButton1))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(data2, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addGap(18, 18, 18))
        );
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        listaCon.addAll(controle.listaConsultasMedPeriodo(ControleMedico.getLogado(), data1.getDate(), data2.getDate()));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            JasperReport relatorio = JasperCompileManager.compileReport("src\\relatorio\\ConsultasMedico.jrxml");
            JasperPrint impressao;

//                Map parametros = new HashMap();
//                parametros.put("data1", data1.getDate());
//                 parametros.put("data2", data2.getDate());
            JRDataSource jrds = new JRBeanCollectionDataSource(controle.listaConsultasMedPeriodo(ControleMedico.getLogado(), data1.getDate(), data2.getDate()));
            Map parametros = new HashMap();
            parametros.put("data1", data1.getDate());
            parametros.put("data2", data2.getDate());
